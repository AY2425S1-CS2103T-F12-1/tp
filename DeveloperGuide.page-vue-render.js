...
with(this){return _c('p',[_c('strong',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Main")])]),_v(" (consisting of classes "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-F12-1/tp/blob/master/src/main/java/seedu/address/Main.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Main")])]),_v(" and "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-F12-1/tp/blob/master/src/main/java/seedu/address/MainApp.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("MainApp")])]),_v(") is in charge of the app launch and shut down.")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("At app launch, it initializes the other components in the correct sequence, and connects them up with each other.")]),_v(" "),_c('li',[_v("At shut down, it shuts down the other components and invokes "),_c('em',[_v("cleanup methods")]),_v(" where necessary.")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-F12-1/tp/blob/master/src/main/java/seedu/address/logic/Logic.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Logic.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-F12-1/tp/blob/master/src/main/java/seedu/address/model/Model.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Model.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("API")]),_v(" : "),_c('a',{attrs:{"href":"https://github.com/AY2425S1-CS2103T-F12-1/tp/blob/master/src/main/java/seedu/address/storage/Storage.java"}},[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Storage.java")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("The undo/redo mechanism is facilitated by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook")]),_v(".\nIt extends "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBook")]),_v(" with an undo/redo history, stored internally as an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addressBookStateList")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("currentStatePointer")]),_v(".\nAdditionally, it implements the following operations:")])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook#commitAddressBook()")]),_v(" — Saves the current address book state in its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook#undoAddressBook()")]),_v(" — Restores the previous address book state from its history.")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("VersionedAddressBook#redoAddressBook()")]),_v(" — Restores a previously undone address book state from its history.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("NUS Computer Science Freshman")]),_v(" "),_c('li',[_v("unfamiliar with the school system(team teams, school structures, communication channels etc.)")]),_v(" "),_c('li',[_v("has no idea where to look for contact info of relevant personnel when certain issues happen, for example\n"),_c('ul',[_c('li',[_v("Informing tutor about absence in tutorial/lab due to illness")]),_v(" "),_c('li',[_v("Asking Prof for clarification/actions on certain admin issues")]),_v(" "),_c('li',[_v("Contact school financial office to settle relevant issues")])])]),_v(" "),_c('li',[_v("has a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("find it frustrating to gather contacts from all types of platforms")]),_v(" "),_c('li',[_v("has the initiatives to jot down contact info when such information is given during the class")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Y1 CS Student")]),_v(" "),_c('td',[_v("add a contact")]),_v(" "),_c('td',[_v("start tracking my contacts on this app")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Y1 CS student who prefers a clean address book with useful contacts only")]),_v(" "),_c('td',[_v("delete contacts")]),_v(" "),_c('td',[_v("remove contacts that I no longer need to keep track of")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Y1 CS student who hates using a mouse or touchpad")]),_v(" "),_c('td',[_v("access to all functionalities of the app with keyboard")]),_v(" "),_c('td',[_v("manage the contacts in the most efficient way")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("Y1 CS student")]),_v(" "),_c('td',[_v("search for contact info from my address book using name, module code (with role), or tag")]),_v(" "),_c('td',[_v("find their contact immediately and reach out to them to settle any issues")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student")]),_v(" "),_c('td',[_v("navigate to view the full contact list")]),_v(" "),_c('td',[_v("perform an action (like editing or deleting contacts)")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who struggles to remember who to reach out to for certain issues")]),_v(" "),_c('td',[_v("find the correct contact info by searching the category of the issue that I am trying to settle")]),_v(" "),_c('td',[_v("seek help immediately even when I forget who to reach out to")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who wants to seek clarifications/actions from a professor regarding certain issues")]),_v(" "),_c('td',[_v("find contact details of the professor(s) for a course")]),_v(" "),_c('td',[_v("seek help/assistance with ease")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who is sick before a tutorial/lab/exam")]),_v(" "),_c('td',[_v("find contact details of my TA")]),_v(" "),_c('td',[_v("easily inform them about my absence on time")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who is involved in any accident or emergency")]),_v(" "),_c('td',[_v("find contact details of campus security")]),_v(" "),_c('td',[_v("protect me and my friends' safety immediately")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who has financial concerns for school")]),_v(" "),_c('td',[_v("find contact details of nus financial office")]),_v(" "),_c('td',[_v("settle any financial related issues")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who needs to update contact info")]),_v(" "),_c('td',[_v("update contact info for courses in this semester with that in the next semester")]),_v(" "),_c('td',[_v("keep info updated in more efficient ways")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who frequently access some of the contact details but lazy to repeat same commands everytime")]),_v(" "),_c('td',[_v("classify frequently accessed contacts and query them using shorter commands")]),_v(" "),_c('td',[_v("access those frequent contact without wasting too much time")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("New user")]),_v(" "),_c('td',[_v("see usage instructions")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use the App")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who is a fresh man in a cca")]),_v(" "),_c('td',[_v("find contact details of my cca leader/friends")]),_v(" "),_c('td',[_v("settle any cca-related issues with them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who are unsure about the procedure of making an appointment with a doctor")]),_v(" "),_c('td',[_v("find contact details for UHC and NUH easily")]),_v(" "),_c('td',[_v("make appointment with doctor as early as possible")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who are facing an academic challenges and mental issue")]),_v(" "),_c('td',[_v("find contact details of counselling service")]),_v(" "),_c('td',[_v("seek help and support from others before it is too late")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who lives in campus and don't know where to contact with if I need to enquire some information")]),_v(" "),_c('td',[_v("find contact details of campus hostels easily")]),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Y1 CS student who is keen to study together with friends/wants to manage friends know from class")]),_v(" "),_c('td',[_v("find out contact of friends who attend a specific module/course during the semester")]),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("Potential user exploring the app")]),_v(" "),_c('td',[_v("see the app populated with sample data")]),_v(" "),_c('td',[_v("see how the app will look like when it is in use.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Y1 CS student who wants to share my contact list with friends who need them")]),_v(" "),_c('td',[_v("transfer useful data to help others efficiently")]),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Y1 CS student who are unsure about the modules planning but don't know who to reach out for")]),_v(" "),_c('td',[_v("find the respective contact of academic advisors")]),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("Y1 CS student who is unaware of the various opportunities provided by nus and soc")]),_v(" "),_c('td',[_v("find the contact emails and main pages for the opportunities such as SEP, NOC, UROP + ReX, summer school, winter school etc")]),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("User who performed action wrongly when using the app")]),_v(" "),_c('td',[_v("redo/undo current actions")]),_v(" "),_c('td',[_v("perform multiple actions efficiently without wasting time on correcting the mistakes")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ContactCS")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CS freshman")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new contact by providing the relevant contact details (name, email, phone number, module code, etc.)")])]),_v(" "),_c('li',[_c('p',[_v("ContactCS adds the contact under the specified module")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Necessary input such as name is missing.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. ContactCS requests the user to provide the required information")])]),_v(" "),_c('li',[_c('p',[_v("1a2. User enters new data")])]),_v(" "),_c('li',[_c('p',[_v("Steps 1a1 - 1a2 are repeated until the data entered are correct")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The given format is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. ContactCS requests the user to provide the correct format and shows the valid command format")])]),_v(" "),_c('li',[_c('p',[_v("1b2. User enters new input")])]),_v(" "),_c('li',[_c('p',[_v("Steps 1b1 - 1b2 are repeated until the format for the entered input is correct")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. The given contact is a duplicate.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. ContactCS shows an error message telling the user that the contact already exists in ContactCS")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"name":"uc02"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC02 Search contact(s)")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to search for contact(s) by providing one or more of the following:")]),_v(" "),_c('ul',[_c('li',[_v("The name of the contact,")]),_v(" "),_c('li',[_v("The module code (optionally including the role), or")]),_v(" "),_c('li',[_v("A combination of both")])])]),_v(" "),_c('li',[_c('p',[_v("ContactCS shows a list of matching contacts")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. Necessary input of at least one keyword is missing.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. ContactCS requests the user to provide keyword")])]),_v(" "),_c('li',[_c('p',[_v("1a2. User enters new input")])]),_v(" "),_c('li',[_c('p',[_v("Steps 1a1 - 1a2 are repeated until all required fields in the input are complete")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The input format is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. ContactCS requests the user to provide the correct format and shows correct syntax, example")])]),_v(" "),_c('li',[_c('p',[_v("1b2. User enters new input")])]),_v(" "),_c('li',[_c('p',[_v("Steps 1b1 - 1b2 are repeated until the format for the entered input is correct")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. No matching contacts found.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. ContactCS displays a message to the user saying that there is no matching contacts found")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list the contacts")])]),_v(" "),_c('li',[_c('p',[_v("ContactCS shows a list of contacts")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("1a. The list is empty.\n"),_c('ul',[_c('li',[_c('p',[_v("1a1. ContactCS displays a message to the user saying that the list is empty")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC04 Delete a person")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. ContactCS requests the user to provide the correct index")])]),_v(" "),_c('li',[_c('p',[_v("2a2. User enters new index")])]),_v(" "),_c('li',[_c('p',[_v("Steps 2a1 - 2a2 are repeated until the index entered are correct")]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC05 Update contact information")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to "),_c('a',{attrs:{"href":"#uc03"}},[_v("list (UC03)")]),_v(" the contacts or "),_c('a',{attrs:{"href":"#uc02"}},[_v("search (UC02)")]),_v(" for contact(s)")])]),_v(" "),_c('li',[_c('p',[_v("User requests to update contact information for a specific person in the list, providing the new contact details")])]),_v(" "),_c('li',[_c('p',[_v("ContactCS updates the contact details based on the information provided by the user")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The given index is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. ContactCS requests the user to provide the correct index")])]),_v(" "),_c('li',[_c('p',[_v("2a2. User enters new index")])]),_v(" "),_c('li',[_c('p',[_v("Steps 2a1 - 2a2 are repeated until the index entered are correct")]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. The given format is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. ContactCS requests the user to provide the correct format and shows the valid command format")])]),_v(" "),_c('li',[_c('p',[_v("2b2. User enters new input")])]),_v(" "),_c('li',[_c('p',[_v("Steps 2b1 - 2b2 are repeated until the format for the entered input is correct")]),_v(" "),_c('p',[_v("Use case resumes from step 3.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC06 Mark frequently used contacts")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to "),_c('a',{attrs:{"href":"#uc03"}},[_v("list (UC03)")]),_v(" the contacts or "),_c('a',{attrs:{"href":"#uc02"}},[_v("search (UC02)")]),_v(" for contact(s)")])]),_v(" "),_c('li',[_c('p',[_v("User requests to mark certain contacts as frequently accessed")])]),_v(" "),_c('li',[_c('p',[_v("ContactCS marks these contacts for quick access")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC07 Unmark frequently used contacts")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to "),_c('a',{attrs:{"href":"#uc03"}},[_v("list (UC03)")]),_v(" the contacts or "),_c('a',{attrs:{"href":"#uc02"}},[_v("search (UC02)")]),_v(" for contact(s)")])]),_v(" "),_c('li',[_c('p',[_v("User requests to unmark certain contacts as frequently accessed")])]),_v(" "),_c('li',[_c('p',[_v("ContactCS removes the marking from these contacts for quick access")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC08 Access frequently used contacts")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to access frequently used contacts")])]),_v(" "),_c('li',[_c('p',[_v("ContactCS shows a list of matching contacts")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The list for frequently used contacts is empty.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. ContactCS displays a message to the user saying that there is no frequently used contact")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The given format is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. ContactCS requests the user to provide the correct format and shows the valid command format")])]),_v(" "),_c('li',[_c('p',[_v("1b2. User enters new input")])]),_v(" "),_c('li',[_c('p',[_v("Steps 1b1 - 1b2 are repeated until the format for the entered input is correct")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC09 View usage instructions")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view usage instructions for the app")])]),_v(" "),_c('li',[_c('p',[_v("ContactCS displays the usage instructions and commands available for the user")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The given format is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. ContactCS requests the user to provide the correct format and shows the valid command format")])]),_v(" "),_c('li',[_c('p',[_v("1a2. User enters new input")])]),_v(" "),_c('li',[_c('p',[_v("Steps 1a1 - 1a2 are repeated until the format for the entered input is correct")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC10 View app with sample data")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view app with sample data")])]),_v(" "),_c('li',[_c('p',[_v("ContactCS populates the interface with sample data for demonstration purposes")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC11 Undo actions")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to undo the last action")])]),_v(" "),_c('li',[_c('p',[_v("ContactCS reverts to the state before the last action")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. No action has been performed yet.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. ContactCS shows an error message indicating that there is no action to undo")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The given format is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. ContactCS requests the user to provide the correct format and shows the valid command format")])]),_v(" "),_c('li',[_c('p',[_v("1b2. User enters new input")])]),_v(" "),_c('li',[_c('p',[_v("Steps 1b1 - 1b2 are repeated until the format of the entered input is correct")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC12 Redo actions")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests a redo")])]),_v(" "),_c('li',[_c('p',[_v("ContactCS reapplies the last undone action")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User tries to redo an action without having undone one first.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. ContactCS shows an error message indicating that there is no action to redo")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The given format is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. ContactCS requests the user to provide the correct format and shows the valid command format")])]),_v(" "),_c('li',[_c('p',[_v("1b2. User enters new input")])]),_v(" "),_c('li',[_c('p',[_v("Steps 1b1 - 1b2 are repeated until the format of the entered input is correct")]),_v(" "),_c('p',[_v("Use case resumes from step 2.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("The AddressBook should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("The AddressBook should be able to hold up to 1000 persons without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The UI should not lag or freeze anytime during normal usage.")]),_v(" "),_c('li',[_v("All usage of data related to NUS should abide by NUS regulations.")]),_v(" "),_c('li',[_v("The AddressBook should remain backwards compatible, namely all data generated in previous versions should be usable in newer versions.")]),_v(" "),_c('li',[_v("The AddressBook should be easily usable by NUS year 1 Computer Science students with any skill level.")]),_v(" "),_c('li',[_v("Managing contacts will remain as the core feature in all iterations.")]),_v(" "),_c('li',[_v("The AddressBook should not crash for any input given by the user.")]),_v(" "),_c('li',[_v("The AddressBook will remain as a CLI based application.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Architecture Diagram")]),_v(": A visual representation of all the elements that make up part, or all, of a system")]),_v(" "),_c('li',[_c('strong',[_v("high-level design")]),_v(": Representing the system or architecture in an abstract way, without diving into technical details, implementation specifics, or granular components")]),_v(" "),_c('li',[_c('strong',[_v("cleanup methods")]),_v(": Functions or procedures that are invoked to release resources, close connections, or finalize tasks before an application or component shuts down")]),_v(" "),_c('li',[_c('strong',[_v("Sequence Diagram")]),_v(": A visual representation of the sequence of interactions between different objects, components, or actors in a system over time")]),_v(" "),_c('li',[_c('strong',[_v("UI")]),_v(": User Interface - the space where interactions between humans (users) and machines (software or hardware) occur")]),_v(" "),_c('li',[_c('strong',[_v("API")]),_v(": Application Programming Interface - A set of rules, protocols, and tools that allows different software applications to communicate and interact with each other")]),_v(" "),_c('li',[_c('strong',[_v("GUI")]),_v(": Graphical User Interface - A type of user interface that allows users to interact with software applications or devices through graphical elements rather than using text-based commands")]),_v(" "),_c('li',[_c('strong',[_v("JavaFx")]),_v(": A Java library used for building modern GUIs")]),_v(" "),_c('li',[_c('strong',[_v("lifeline (in a Sequence Diagram)")]),_v(": A graphical element that depicts the lifespan of an object or actor in the system as interactions occur over time")]),_v(" "),_c('li',[_c('strong',[_v("JSON")]),_v(": An open standard file format and data interchange format that uses human-readable text to store and transmit data objects consisting of attribute–value pairs and arrays")]),_v(" "),_c('li',[_c('strong',[_v("CLI app")]),_v(": Command-Line Interface application - A software application that allows users to interact with it through a text-based interface by typing commands in a console or terminal")]),_v(" "),_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Make find command shorter by allowing fuzzy search of module-role, such that user can find all contacts with roles related to a specified module, just by inputting module code or even fraction of it.\n(For example:"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find r/CS2103T")]),_v(" finds all contacts related to CS2103T, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find r/CS")]),_v(" finds all contacts related to modules whose module codes start with CS).")]),_v("\nThe current find command automatically assumes that user wants to search student role if only a module code is supplied to the find command, which may be counter-intuitive to some users.\nSometimes, user cannot remember the full module code, or wants to search over a wider range of modules, but the current implementation does not support that either,\nhence reducing the usefulness of this command.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"/tp/images/Planned_Enhancements_Screenshots/Point1_1.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images/Planned_Enhancements_Screenshots/Point1_1.png","alt":"point1 screenshot_1"}})]),_v("\n(As shown in the screenshot, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find r/CS1101S")]),_v(" only matches contacts with role "),_c('strong',[_v("CS1101S Student")]),_v(", despite that there are 2 CS1101S professors in the sample data.)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"/tp/images/Planned_Enhancements_Screenshots/Point1_2.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images/Planned_Enhancements_Screenshots/Point1_2.png","alt":"point1 screenshot_2"}})]),_v("\n(As shown in the screenshot, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find r/CS")]),_v(" results in error messages because construction of search query requires exact module code to work.)")])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"2"}},[_c('li',[_c('strong',[_v("Allow deletion of other optional data fields of a contact, using the current edit command approach.")]),_v(" Currently, only the description and tag fields can be deleted, by specifying the corresponding prefix followed by an empty string (For Example: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 9 t/")]),_v(" removes all tags, while "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 9 d/")]),_v(" removes the description of the ninth contact in the current list). However, other optional fields such as the phone, email and address cannot be removed as of v1.6.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"/tp/images/Planned_Enhancements_Screenshots/Point2_RemoveDescriptionExample.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images/Planned_Enhancements_Screenshots/Point2_RemoveDescriptionExample.png","alt":"point2_screenshot_remove_description_example"}})]),_v("\n(As shown in the screenshot, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 9 d/")]),_v(" successfully removes description field from the ninth person in the current list.)")])}
},function anonymous(
) {
...
with(this){return _c('ol',{attrs:{"start":"3"}},[_c('li',[_c('strong',[_v("Allow the user to delimit special prefixes appearing in the contact details.")]),_v("\nCurrently, if any of the input fields contain the special prefixes, the string will be split into multiple fields, which may not be the user's intention.\nFor example, if the user attempts to execute "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 d/For a/b testing")]),_v(", the command will be wrongly interpreted as\n"),_c('ul',[_c('li',[_v("change the description of the first contact to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("For")]),_v(", and")]),_v(" "),_c('li',[_v("add a new contact with description "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("b testing")]),_v(". (refer to the screenshot below)")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"/tp/images/Planned_Enhancements_Screenshots/Point3.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images/Planned_Enhancements_Screenshots/Point3.png","alt":"point3 screenshot"}})])])}
},function anonymous(
) {
with(this){return _c('p',[_v("The current workaround is to add a non-whitespace character in front of the prefix (i.e. "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 1 d/For 'a/b testing")]),_v("), but this is not intuitive to the user.\nWe plan to follow a more standard approach of using a backslash to escape the special prefixes.\nMore importantly, the parser will remove the backslash at the end of parsing, so that the user does not see the backslash in the final output.")])}
},function anonymous(
) {
with(this){return _c('ol',{attrs:{"start":"4"}},[_c('li',[_c('strong',[_v("Enforce realistic role assignment for contacts.")]),_v(" Currently, a contact can have multiple roles, such as both \"Professor\" and \"Student\".\nThis is unrealistic, as an individual is typically either a student or a professor, but not both.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"/tp/images/Planned_Enhancements_Screenshots/Point4_ConflictingRoleExample.png","target":"_self"}},[_c('img',{staticClass:"img-fluid",attrs:{"src":"/tp/images/Planned_Enhancements_Screenshots/Point4_ConflictingRoleExample.png","alt":"point4_screenshot"}})]),_c('br'),_v("\n(As shown in the screenshot, Royston is both a CS1101S professor and CS2100 student.)")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Mon, 11 Nov 2024, 23:55:28 GMT+8]")])])])}
}];
