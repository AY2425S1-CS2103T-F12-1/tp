...
with(this){return _c('ol',{attrs:{"start":"2"}},[_c('li',[_c('strong',[_v("Allow deletion of other optional data fields of a contact, using the current edit command approach.")]),_v(" Currently, only the description and tag fields of a contact can be deleted, by editing the contact description field with\nan empty string (For Example: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("edit 9 d/")]),_v(" removes description of the ninth contact in the current list), and not any other optional fields such as phone, email and address.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Mon, 11 Nov 2024, 21:44:05 GMT+8]")])])])}
}];
